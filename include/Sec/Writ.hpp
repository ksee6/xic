/**
 * @file Writ.hpp
 * @brief Cryptographic trust document (Writ) for the Xi framework.
 */
...
/**
 * @struct Writ
 * @brief Represents a cryptographic trust document containing a public key, metadata, and signature.
 */
