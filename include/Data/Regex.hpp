...
namespace Xi {
template <> struct FNVHasher<Data::Regex::DFAState> {
  static usz fnvHash(const Data::Regex::DFAState &s) {
    return Data::Regex::DFAState::fnvHash(s);
  }
};
} // namespace Xi

#endif // XI_DATA_REGEX_HPP
